 ...
 */
abstract class MvvmBindingFragment<VM : ViewModel, B : ViewDataBinding> : Fragment(), LoaderManager.LoaderCallbacks<VM> {
     ...
     */
    private var loaderID: Int = LoaderIdGenerator.ACTIVITY_ID
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val savedLoaderId = savedInstanceState?.getInt(LOADER_ID_KEY, LoaderIdGenerator.ACTIVITY_ID) ?: loaderID
